    ...
    <div>
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="aurora-wrap absolute inset-0">
          <div className="aurora-blob-a absolute -top-32 -left-24 w-[55vw] h-[55vw] rounded-full bg-[#E0241C]/30 blur-[130px]" />
          <div className="aurora-blob-b absolute top-1/4 -right-24 w-[50vw] h-[50vw] rounded-full bg-[#10B981]/22 blur-[140px]" />
          <div className="aurora-blob-c absolute bottom-0 left-1/4 w-[48vw] h-[48vw] rounded-full bg-[#3B82F6]/22 blur-[140px]" />
          <div className="aurora-blob-d absolute top-1/3 left-1/3 w-[42vw] h-[42vw] rounded-full bg-[#A855F7]/18 blur-[130px]" />
        </div>
        {/* Veil keeps foreground readable — light in light mode, dark in dark mode */}
        <div className="absolute inset-0 bg-white/60 dark:bg-[#070707]/60" />
        <div
      ...
      <div className="relative z-10">
        ...
        {!kycDismissed && profile?.kyc_status === 'None' && (
          <div className="flex items-start gap-3 p-4 bg-white border border-slate-200 dark:bg-[#161616] dark:border-white/10 rounded-2xl">
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-3 mt-6">
              ...
              <Link
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-full bg-slate-100 text-slate-900 hover:bg-slate-200 border border-slate-200 dark:bg-[#1c1c1c] dark:text-white dark:hover:bg-[#262626] dark:border-white/10 text-sm font-bold transition-colors"
              >
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={s.label} className="bg-white border border-slate-200 dark:bg-[#161616] dark:border-white/[0.08] rounded-2xl p-4 text-center hover:border-brand-primary/25 transition-colors">
        ...
        {/* My Shares */}
        {holdings.length > 0 && (
          <div className="bg-white border border-slate-200 dark:bg-[#161616] dark:border-white/[0.08] rounded-2xl overflow-hidden">
        ...
        {/* Portfolio chart */}
        {balance > 0 && (
          <div className="bg-white border border-slate-200 dark:bg-[#161616] dark:border-white/8 rounded-2xl p-5">
        ...
        {/* Recent transactions */}
        <div className="bg-white border border-slate-200 dark:bg-[#161616] dark:border-white/8 rounded-2xl overflow-hidden">
        ...
        <Link
          ...
          className="flex items-center justify-between w-full px-5 py-4 rounded-2xl bg-white border border-slate-200 hover:bg-slate-50 dark:bg-[#161616] dark:border-white/8 dark:hover:bg-[#1f1f1f] transition-colors group"
        >
          <div>
